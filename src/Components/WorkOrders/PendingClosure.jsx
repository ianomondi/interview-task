...
const PendingClosure = () => {
  ...
  const filterByAssetCategory = filterViaProperty(
    sortedRequestsData,
    assetCategories,
    "category"
  );
  ...
  const locations = getUniqueProperty(filterByAssetCategory, "location");
